 <template>
	<div class="group focus-outer">
		...
		<div class="numberBox">
			...
			<div class="inputBox">
				<span class="numButton numButton-disable" id="numBtnSub" @click="handleClickSub" :class="{'numButton-disable': decBtnFlag}">
					<span class="iconfont">&#xe63d;</span>
				</span>
				<input type="text" class="inputeItem" id="nowNum" v-model="num" @keyup="checkInput"/>
...
<script>
	...
	export default {
		...
		methods: {
			...
			checkInput() {
				let inputEl = document.getElementById("nowNum"),
					value = inputEl.value;
				if (value.length > 4) {
